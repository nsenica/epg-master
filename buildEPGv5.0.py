...
tomorrow=today+datetime.timedelta(days=days_to_check)
...
meo_url="http://services.sapo.pt/EPG/GetChannelByDateInterval?channelSigla={0}&startDate={1}+00%3A00%3A00&endDate={2}+00%3A00%3A00"
es_url="https://neulionmdnyc-a.akamaihd.net/u/mt1/elevensportspt/epg/{0}/{1}/{2}/{3}.js?"
...
for channel in channels:
    ...
    if provider.firstChild.data == 'MEO':
        ...
        link = meo_url.format(provCode.firstChild.data.encode('utf-8'), sDate, eDate)
        ...
        for tvgID in tvgIDs:
            for program in programs:
                ...
                n=n+1
    elif provider.firstChild.data == 'ES':
        d = today
